...
public class AVLPane extends Pane
{
                             ...
                             double x, double y, double hGap)
    {
        ...
        if (root.left != null)
        {
            ...
            balanceFactor -= ((AVLTree.AVLTreeNode<Integer>) root.left).height;
        }
        ...
        if (root.right != null)
        {
            ...
            balanceFactor += ((AVLTree.AVLTreeNode<Integer>) root.right).height;
        }
        ...
        getChildren().addAll(circle,
                new Text(x-radius+1, y + 4, root.element + ":" + balanceFactor));
    }
}
