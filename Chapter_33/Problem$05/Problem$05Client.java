...
public class Problem$05Client extends Application
{
    ...
    public void start(Stage stage)
    {
        ...
        stage.setTitle("Problem$05Client");
        stage.show();
        ...
        submit.setOnAction(e ->
        {
            ...
            try
            {
                Loan loan = new Loan(interestRate_, years_, amount_);
        ...
        try
        {
            Socket socket = new Socket(Problem$05Server.NAME, Problem$05Server.PORT);
