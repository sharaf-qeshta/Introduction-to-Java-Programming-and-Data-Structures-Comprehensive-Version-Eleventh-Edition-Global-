 ...
 * in the stack and replace the two operands with the result. The following
 * diagram shows how to evaluate 1 2 + 3 *:
 *
 * Write a program to evaluate postfix expressions. Pass the expression
 * as a command-line argument in one string
 *
 *
 *
