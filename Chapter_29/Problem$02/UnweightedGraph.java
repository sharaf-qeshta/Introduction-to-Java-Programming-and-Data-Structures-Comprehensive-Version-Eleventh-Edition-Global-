...
public class UnweightedGraph<V> implements Graph<V>
{
    ...
    protected Edge[][] neighbors = new Edge[0][0];// Adjacency Edge matrix
    ...
    protected UnweightedGraph(V[] vertices, int[][] edges)
    {
        ...
        createAdjacencyMatrix(edges, vertices.length);
    }
    ...
    protected UnweightedGraph(List<V> vertices, List<Edge> edges)
    {
        ...
        createAdjacencyMatrix(edges, vertices.size());
    }
    ...
    protected UnweightedGraph(List<Edge> edges, int numberOfVertices)
    {
        ...
        createAdjacencyMatrix(edges, numberOfVertices);
    }
     ...
     */
    private void createAdjacencyMatrix(int[][] edges, int numberOfVertices)
    {
     ...
     * Create adjacency lists for each vertex
     */
    private void createAdjacencyMatrix(List<Edge> edges, int numberOfVertices)
    {
        for (Edge edge : edges)
            addEdge(edge);
    }
    ...
    public boolean addVertex(V vertex)
    {
        ...
        {
            vertices.add(vertex);
            Edge[][] temp = new Edge[vertices.size()][vertices.size()];
            for (int i = 0; i < neighbors.length; i++)
                for (int j = 0; j < neighbors.length; j++)
                    temp[i][j] = neighbors[i][j];
            neighbors = temp;
            return true;
        }
        else
    ...
    public boolean addEdge(Edge e)
    {
        ...
        if (neighbors[e.u][e.v] == null) // edge does not exist
        {
            neighbors[e.u][e.v] = e;
            return true;
        }
