...
public class WeightedGraph<V> extends UnweightedGraph<V> implements Serializable
{
     ...
     */
    public class MST extends SearchTree implements Serializable
    {
     ...
     */
    public class ShortestPathTree extends SearchTree implements Serializable
    {
